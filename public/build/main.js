...
(() => {
  ...
  function create_if_block_4(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        attr_dev(div, "class", "field svelte-1f0evgz");
  ...
  function create_each_block(key_1, ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        attr_dev(button, "class", "svelte-1f0evgz");
        add_location(button, file, 79, 5, 2431);
        attr_dev(div, "class", div_class_value = "block" + ctx[7].id + " svelte-1f0evgz");
      ...
      p: function update2(new_ctx, dirty) {
        ...
        if (dirty & 1 && div_class_value !== (div_class_value = "block" + ctx[7].id + " svelte-1f0evgz")) {
